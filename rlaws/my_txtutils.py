...
# nemelt: DEC 1040 - 1071 tom oros A-Ya
# 1072 - 1103 jijig oros a-ya
# 1256 tom O, 1257 jijig o
# 1198 tom U, 1199 jijig u
# 1025 tom Yo, 1105 jijig yo
...
def convert_from_alphabet(a):
    ...
    if a == 10:
        ...
        return a - 994 #Tom jijig Oros A-Ya
    elif a == 1105:
        return 115 #Jijig yo
    elif 1198 <= a <= 1199:
        return a - 1086 #Tom jijig U
    elif 1256 <= a <= 1257:
        return a - 1146 #Tom jijig O
    else:
        return 0  # unknown
